...
ggplot(aes(x=age,y=friend_count),
  ...
  geom_line(stat='summary', fun.y=mean, linetype=3, color='orange')
...
#alternative verbose form

yo$all.purchases <- yo$strawberry + yo$blueberry + yo$pina.colada +
                  yo$plain + yo$mixed.berry
